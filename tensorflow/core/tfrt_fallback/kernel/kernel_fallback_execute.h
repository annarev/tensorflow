...
==============================================================================*/
//===- kernel_fallback_execute.h --------------------------------*- C++ -*-===//
//
// Provides a way to execute a TensorFlow kernel using TFRT kernel fallback.
//===----------------------------------------------------------------------===//
#ifndef TENSORFLOW_CORE_TFRT_FALLBACK_KERNEL_KERNEL_FALLBACK_EXECUTE_H_
#define TENSORFLOW_CORE_TFRT_FALLBACK_KERNEL_KERNEL_FALLBACK_EXECUTE_H_
...
#endif  // TENSORFLOW_CORE_TFRT_FALLBACK_KERNEL_KERNEL_FALLBACK_EXECUTE_H_
